...
The main idea is to find parameters that minimize the difference between predictions and actual data. For example, in my college assignment:

Input X: Number of hospitals implementing full RME
Output Y: Accreditation percentage

This model studies the equation f(x) = wx + b
